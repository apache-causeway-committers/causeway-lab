...
public abstract class FieldModelAbstract2<T>
extends FieldModelAbstract<T> {

    private static final long serialVersionUID = 1L;

    protected FieldModelAbstract2(
    ...
    //private Bindable<T> bindableValue = _Bindables.empty();
    //private Bindable<T> bindablePendingValue = _Bindables.empty();
