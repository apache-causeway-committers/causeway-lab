...
public class ScalarParameterModel
    ...
    public static ScalarParameterModel wrap(final UiParameterVdn delegate) {
        return new ScalarParameterModel(delegate);
    }

    @Getter(onMethod_ = {@Override})
    private final UiParameterVdn uiParameter;
    ...
    private ScalarParameterModel(
            final UiParameterVdn uiParameter) {
        super(
                UiObjectVdn.ofAdapter(uiParameter.getOwner()),
