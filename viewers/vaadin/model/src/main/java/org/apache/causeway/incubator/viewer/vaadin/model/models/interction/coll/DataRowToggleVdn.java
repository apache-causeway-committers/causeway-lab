...
import org.apache.causeway.incubator.viewer.vaadin.model.models.binding.BooleanBinding;
 ...
 */
public class DataRowToggleVdn
        extends BooleanBinding<DataRow> {

    private static final long serialVersionUID = 1L;

    public DataRowToggleVdn(final IModel<DataRow> dataRowVdn) {
        super(dataRowVdn);
    }
