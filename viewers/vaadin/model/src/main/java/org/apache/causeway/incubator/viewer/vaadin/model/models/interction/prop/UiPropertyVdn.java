 ...
 *  under the License.
 */
package org.apache.causeway.incubator.viewer.vaadin.model.models.interction.prop;
...
/**
 * <i>Property Interaction</i> model bound to its owner {@link PropertyInteractionVdn}.
 *
 * @see PropertyInteractionVdn
 * @see ChainingModel
 */
public final class UiPropertyVdn
        extends ChainingModel<PropertyInteraction>
        implements HasCommonContext, HasUiParentObject<UiObject>, UiProperty {

    private static final long serialVersionUID = 1L;

    UiPropertyVdn(
            final PropertyInteractionVdn model) {
        super(model);
    }
    ...
    public final PropertyInteractionVdn propertyInteractionModel() {
        return (PropertyInteractionVdn) getChainedModel();
    }
