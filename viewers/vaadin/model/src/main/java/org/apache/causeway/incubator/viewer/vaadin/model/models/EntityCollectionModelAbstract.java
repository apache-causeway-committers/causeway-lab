 ...
 *
 * @implSpec <pre>
 * EntityCollectionModel --chained-to--> CollectionInteractionVdn (delegate)
 * </pre>
 */
public abstract class EntityCollectionModelAbstract
    ...
    protected EntityCollectionModelAbstract(
            final DataTableModelVdn dataTableModelVdn,
            final @NonNull Variant variant) {
        super(dataTableModelVdn);
        this.variant = variant;
    }

    public final DataTableModelVdn delegate() {
        return (DataTableModelVdn) super.getTarget();
    }
     ...
     */
    private final List<LinkAndLabel> linkAndLabels = _Lists.newArrayList();
