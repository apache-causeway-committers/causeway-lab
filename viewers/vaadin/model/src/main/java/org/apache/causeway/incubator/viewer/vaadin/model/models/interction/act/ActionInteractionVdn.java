 ...
 *  under the License.
 */
package org.apache.causeway.incubator.viewer.vaadin.model.models.interction.act;
...
import org.apache.causeway.incubator.viewer.vaadin.model.models.InlinePromptContext;
import org.apache.causeway.incubator.viewer.vaadin.model.models.ScalarParameterModel;
import org.apache.causeway.incubator.viewer.vaadin.model.models.ScalarPropertyModel;
...
import org.apache.causeway.wicketstubs.api.ChainingModel;
 ...
 * @see ChainingModel
 */
public class ActionInteractionVdn
    ...
    private Can<UiParameterVdn> childModels;
    private final @Nullable ScalarPropertyModel associatedWithPropertyIfAny;
    private final @Nullable ScalarParameterModel associatedWithParameterIfAny;
    private final @Nullable EntityCollectionModel associatedWithCollectionIfAny;

    public static ActionInteractionVdn forEntity(
            final UiObjectVdn parentEntityModel,
        ...
        return new ActionInteractionVdn(
    ...
    public Stream<UiParameterVdn> streamParameterUiModels() {
        if (childModels == null) {
            final int paramCount = getMetaModel().getParameterCount();
            this.childModels = IntStream.range(0, paramCount)
                    .mapToObj(paramIndex -> new UiParameterVdn(this, paramIndex))
                    .collect(Can.toCan());
        }
