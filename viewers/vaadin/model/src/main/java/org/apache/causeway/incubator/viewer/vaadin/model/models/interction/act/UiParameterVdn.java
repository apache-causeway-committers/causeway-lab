...
/**
 * <i>Action Parameter Interaction</i> model bound to its owner {@link ActionInteractionVdn}.
 *
 * @see ActionInteractionVdn
 */
public final class UiParameterVdn
    ...
    UiParameterVdn(
            final ActionInteractionVdn model,
            final int paramIndex) {
        super(model);
    ...
    public final ActionInteractionVdn actionInteractionModel() {
        return (ActionInteractionVdn) getChainedModel();
    }
