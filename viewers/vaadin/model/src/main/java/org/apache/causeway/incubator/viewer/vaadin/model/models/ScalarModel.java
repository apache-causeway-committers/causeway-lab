...
import org.apache.causeway.incubator.viewer.vaadin.model.value.ConverterBasedOnValueSemantics;
...
//import org.apache.causeway.commons.internal.debug._XRay;
...
public abstract class ScalarModel
    ...
    private final UiObjectVdn parentEntityModel;
    ...
    protected ScalarModel(
            final UiObjectVdn parentUiObject,
     ...
     */
    protected ScalarModel(
            final @NonNull UiObjectVdn parentEntityModel,
    ...
    public <T> IModel<T> unwrapped(final Class<T> type) {
        return (IModel<T>) new ScalarUnwrappingModel<T>(type, this);
    }
...
//FIXME            _Xray.onSclarModelUpdate(this, oldValue, newValue);
    ...
    @Override
    public final UiObjectVdn getParentUiModel() {
