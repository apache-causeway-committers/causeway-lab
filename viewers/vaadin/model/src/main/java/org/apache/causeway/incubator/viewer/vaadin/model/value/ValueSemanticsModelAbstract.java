 ...
 *  under the License.
 */
package org.apache.causeway.incubator.viewer.vaadin.model.value;
...
import org.apache.causeway.wicketstubs.ConversionException;
...
abstract class ValueSemanticsModelAbstract
    ...
    public abstract Object convertToObject(String text, Locale locale) throws ConversionException;

    public abstract String convertToString(Object value, Locale locale);
