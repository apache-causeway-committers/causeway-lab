 ...
 * @see ChainingModel
 */
public class PropertyInteractionVdn
    ...
    private Can<UiPropertyVdn> childModels;

    public PropertyInteractionVdn(
    ...
    public Stream<UiPropertyVdn> streamPropertyUiModels() {
        if(childModels==null) {
            childModels = Can.ofSingleton(new UiPropertyVdn(this));
        }
