...
//                .collect(Collectors.toCollection(HashSet::new));
        ...
        _Casts.castTo(UiObjectVdn.class, bookmarkableModel)
                .map(UiObjectVdn::getIconAsResourceReference)
    ...
    public boolean matches(final BookmarkableModel candidateBookmarkableModel) {
        if (candidateBookmarkableModel instanceof UiObjectVdn) {
            return matchAndUpdateTitleFor((UiObjectVdn) candidateBookmarkableModel);
        }
        return false;
    }
    ...
    /**
     * Whether or not the provided {@link UiObjectVdn} matches that contained
     * within this node, or any of its children.
     *
     * <p>
     ...
     * @return - whether the provided candidate is found or was added to this node's tree.
     */
    private boolean matchAndUpdateTitleFor(final UiObjectVdn candidateEntityModel) {
