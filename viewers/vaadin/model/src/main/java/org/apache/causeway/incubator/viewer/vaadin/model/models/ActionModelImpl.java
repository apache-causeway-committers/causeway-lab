...
import org.apache.causeway.incubator.viewer.vaadin.model.models.interction.act.ActionInteractionVdn;
import org.apache.causeway.incubator.viewer.vaadin.model.models.interction.act.UiParameterVdn;
 ...
 * ActionModel --bound-to--> ActionInteractionVdn (delegate)
 * </pre>
 */
public final class ActionModelImpl
    ...
    public static ActionModelImpl forEntity(
        ...
        val delegate = ActionInteractionVdn.forEntity(
                parentEntityModel,
                actionIdentifier,
                where,
    ...
    private final ActionInteractionVdn delegate;

    private ActionModelImpl(final UiObjectVdn parentEntityModel, final ActionInteractionVdn delegate) {
    ...
    @Override
    public UiObjectVdn getParentUiModel() {
        return (UiObjectVdn) super.getTarget();
    }
    ...
    @Override
    public Stream<UiParameterVdn> streamPendingParamUiModels() {
