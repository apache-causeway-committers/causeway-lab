...
public class ConverterBasedOnValueSemantics<T>
     ...
     */
    @Override
    public final String convertToString(final Object value, final Locale locale) {
