 ...
 *  under the License.
 */
package org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable;
...
import org.apache.causeway.incubator.viewer.vaadin.model.models.EntityCollectionModel.Variant;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collection.bulk.MultiselectToggleProvider;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collection.count.CollectionCountProvider;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.ColumnAbbreviationOptions;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.GenericColumn;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.PluralColumn;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.SingularColumn;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.TitleColumn;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.collectioncontents.ajaxtable.columns.ToggleboxColumn;
import org.apache.causeway.incubator.viewer.vaadin.ui.components.filter.table.FilterToolbar;
...
public class CollectionContentsAsAjaxTablePanel
    ...
    private void buildGui() {
        ...
        if (toggleboxColumn != null) {
            columns.add(0, (GenericColumn) toggleboxColumn);
        }
    ...
    private void addOrReplace(CausewayAjaxDataTable dataTable) {
    }

    private MultiselectToggleProvider getMultiselectToggleProvider() {
        CollectionContentsAsAjaxTablePanel component = this;
    ...
    private CollectionContentsAsAjaxTablePanel getParent() {
        return null;
    }
...
/*        Vdn.addIfElseHide(dataTableInteractive().isSearchSupported(),
    ...
    private PluralColumn createPluralColumn(final OneToManyAssociation collection) {
        ...
        return new PluralColumn(
                ...
                PluralColumn.RenderOptions.builder().build());
    }
