 ...
 *  under the License.
 */
package org.apache.causeway.incubator.viewer.vaadin.ui.app.registry;
...
public interface ComponentFactoryRegistry {
    ...
    <T, M extends IModel<T>> Component addOrReplaceComponent(PanelAbstract<T,M> tmPanelAbstract, UiComponentType uiComponentType, IModel<?> model);
}