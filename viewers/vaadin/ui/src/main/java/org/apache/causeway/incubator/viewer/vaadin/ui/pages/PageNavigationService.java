...
public interface PageNavigationService extends Serializable {
    ...
    /**
     * Schedules a page with a given {@link PageType type}
    ...
    /**
     * Schedules a page with a given {@link PageType type}
     * and {@link PageParameters parameters} to provide the response
     *
     * @param pageType The type of the page that should provide the response
     ...
     * the application can return later by using {@link Component#continueToOriginalDestination()}
     *
     * @param pageType The type of the page that should provide the response
     */
