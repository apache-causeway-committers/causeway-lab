...
...
    ...
    <mb3:menu>
        ...
        <mb3:section>
            ...
            <mb3:serviceAction objectType="isis.ext.secman.ApplicationFeatureViewModels" id="allClasses">
                <cpt:named>All Classes</cpt:named>
            </mb3:serviceAction>
            <mb3:serviceAction objectType="isis.ext.secman.ApplicationFeatureViewModels" id="allPackages">
